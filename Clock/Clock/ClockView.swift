...
class ClockView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        if let context = UIGraphicsGetCurrentContext() {
            ...
            // fills color in shape that was drawn
            ...
            let insertCircleRect = CGRect(x: rect.origin.x + borderWidth / 2,
                                          y: rect.origin.x + borderWidth / 2,
                                          width: rect.size.width,
                                          height: rect.size.height)
            
            context.addEllipse(in: insertCircleRect)
